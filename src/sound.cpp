  ...
  channels()
{
  ...
  music = Mix_LoadMUS("sound/POL-coconut-land-short.wav");
  ...
  startMusic();
  sounds.push_back(Mix_LoadWAV("sound/smb_pause.wav"));
  sounds.push_back(Mix_LoadWAV("sound/smb_jump-super.wav"));
  sounds.push_back(Mix_LoadWAV("sound/smb_fireball.wav"));
  sounds.push_back(Mix_LoadWAV("sound/smb_kick.wav"));
  sounds.push_back(Mix_LoadWAV("sound/smb_mariodie.wav"));
  sounds.push_back(Mix_LoadWAV("sound/smb_stage_clear.wav"));
